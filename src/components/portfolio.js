...
const images = [
    ...
    { src: './images/synergy.png', alt: 'Agri Synergy : Une meilleure agriculture pour un avenir meilleur', description: 'Nous cultivons principalement des cultures tropicales telles que le plantain, l’avocatier, les agrumes et le palmier à huile. Chaque culture est adaptée à notre climat et gérée selon des pratiques agricoles durables.', lien: 'https://synergy.nilservice.net/' },
    { src: './images/dechet.png', alt: 'Gestion déchet 237 : Application mobile dedié à la gestion intelligente des déches', description: 'Cette application mobile a été conçue dans le cadre d’un projet technologique visant à améliorer la gestion des déchets urbains. Elle permet aux utilisateurs de localiser les points de collecte, de suivre le niveau de remplissage des bacs connectés', lien: '#' },
    { src: './images/coquine.png', alt: 'Coquine Service : Rencontrez des escortes locales en ligne dès maintenant!', description: 'Nous pensons que chaque rencontre doit être une expérience mémorable. Nous sélectionnons soigneusement les profils sur notre site, en veillant à ce que chaque annonce reflète la qualité, le charme et le professionnalisme.', lien : 'https://coquineservice.com/' },
  ...
  const endIndex = startIndex + blockSize;
    return(
        ...
        <div className="image-gallery" id='portfolio'>
         <h2>Portfolio</h2>
         <p>Ci-dessous, quelques exemples de réalisations effectuées à titre personnel pour des clients :</p>
        <div className="row">
